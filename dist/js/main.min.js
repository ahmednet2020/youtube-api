...
var App = function (_React$Component) {
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_reactRouterDom.Route, { path: '/', render: function render(props) {
								return _react2.default.createElement(_navbar2.default, _extends({}, props, { on: _this2.state.login }));
							} })
					),
					_react2.default.createElement(
						_reactRouterDom.Switch,
						...
						_react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/logout', render: function render() {
								return _this2.state.login ? _react2.default.createElement(
									'button',
									{ type: 'button', onClick: _this2.Signout },
									'logout'
						...
						_react2.default.createElement(_reactRouterDom.Route, { path: '/login', render: function render() {
								return _this2.state.login ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/logout' }) : _react2.default.createElement(_Login2.default, { singin: _this2.Signin });
							} }),
						_react2.default.createElement(_private2.default, { path: '/chanel', auth: this.state.login, component: _Chanel2.default }),
   ...
   */
			var updateSigninStatus = function updateSigninStatus(isSignedIn) {
				if (isSignedIn) {
					_this3.setState({ login: true });
					_this3.getChannel('OsamaElzero');
					console.log("login");
				} else {
					_this3.setState({ login: false });
					console.log("logout");
				}
			};
			/**
...
},{"../worker/workers":82,"./apiConfig":69,"./components/navbar":73,"./components/preload":76,"./components/private":77,"./pages/Chanel":78,"./pages/Home":79,"./pages/Login":80,"./pages/Page404":81,"react":65,"react-dom":37,"react-router-dom":50}],71:[function(require,module,exports){
"use strict";
...
},{"react":65,"react-router-dom":50}],72:[function(require,module,exports){
"use strict";
...
},{"react":65}],73:[function(require,module,exports){
'use strict';
...
},{"./navtoggel":75,"react":65,"react-router-dom":50}],74:[function(require,module,exports){
"use strict";
...
},{"react":65,"react-router-dom":50}],75:[function(require,module,exports){
'use strict';
...
},{"./navlist":74,"react":65}],76:[function(require,module,exports){
"use strict";
...
var Private = function Private(_ref) {
	...
	return _react2.default.createElement(_reactRouterDom.Route, { path: path, render: function render(props) {
			return auth ? _react2.default.createElement(Component, props) : _react2.default.createElement(_reactRouterDom.Redirect, { to: "/login" });
		} });
};

exports.default = Private;

},{"react":65,"react-router-dom":50}],78:[function(require,module,exports){
'use strict';
...
},{"../components/preload":76,"react":65}],79:[function(require,module,exports){
'use strict';
...
},{"../components/preload":76,"react":65}],80:[function(require,module,exports){
'use strict';
...
},{"../components/loginform":71,"../components/loginservices":72,"../components/preload":76,"react":65}],81:[function(require,module,exports){
"use strict";
...
},{"react":65,"react-router-dom":50}],82:[function(require,module,exports){
'use strict';
